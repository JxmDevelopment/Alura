...
function calculaPontos(jogador) {
  ...
  return pontos; // guarda dentro de 'pontos'
}

jog1.pontos = calculaPontos(jog1); // Calcula os pontos da Rafa, faz o calculo e armazena dentro de Rafa
jog2.pontos = calculaPontos(jog2);
jog3.pontos = calculaPontos(jog3);
jog4.pontos = calculaPontos(jog4);

var jogadores = [jog1, jog2, jog3, jog4];
